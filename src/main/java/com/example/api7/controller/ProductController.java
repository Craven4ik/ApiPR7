...
public class ProductController {
    ...
    public Product createProduct(@Argument ProductInput productInput) {
        Product product = new Product(productInput.text, productInput.quantity, productInput.completed, productInput.producer);
        return productRepository.save(product);
    }

    record ProductInput(String text, Integer quantity, Boolean completed, String producer) {
    }
}
